this.workbox = this.workbox || {}, this.workbox.backgroundSync = function(t, e, s, i, n) {
    ...
    class c {
        constructor(t) {
            this.t = t, this.i = new n.DBWrapper("workbox-background-sync", 3, {
        ...
        async unshiftEntry(t) {
            ...
            e ? t.id = e.id - 1 : delete t.id, t.queueName = this.t, await this.i.add(a, t)
        }
        async popEntry() {
            return this.o({
                direction: "prev"
        ...
        h(t) {
            ...
            t.oldVersion > 0 && t.oldVersion < 3 && e.objectStoreNames.contains(a) && e.deleteObjectStore(a);
    ...
    class f {
        constructor(t, {
            ...
            if (this.l = !1, this.q = !1, y.has(t)) throw new e.WorkboxError("duplicate-queue-name", {
                name: t
            });
            y.add(t), this.m = t, this.p = s || this.replayRequests, this.g = i || 10080, this.R = new c(this.m), this.k()
        }
        get name() {
            return this.m
        }
        ...
        async D({
            ...
            e && (n.metadata = e), await this.R[i + "Entry"](n), this.l ? this.q = !0 : await this.registerSync()
        }
        async _(t) {
            const e = Date.now(),
                ...
                if (t.tag === `${u}:${this.m}`) {
                    const e = async () => {
                        ...
                        try {
                            ...
                            !this.q || e && !t.lastChance || await this.registerSync(), this.l = !1, this.q = !1
                        }
                    };
                    t.waitUntil(e())
                }
